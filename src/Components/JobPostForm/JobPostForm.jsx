...
import Step6 from './JobPostStep6'
import './JobPostForm.css'

const JobPostForm = () => {
    const [step, setStep] = useState(1)
    const steps = ['Job Details', 'Candidate Preferences', 'Comany Information', 'Contact & Application Settings', 'Salary & Benefits', 'Review & Publish']
    ...
    const renderStep = () => {
        switch (step) {
            ...
            case 5: return <Step5 formData={formData} handleChange={handleChange} nextStep={nextStep} previousStep={previousStep} />;
            case 6: return <Step6 formData={formData} handleChange={handleChange} previousStep={previousStep} />;
